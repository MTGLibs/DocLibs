...
public class DOCXReader extends AbstractReader
{
    ...
    private boolean isPropertiesFileError(Element body) {
        ...
        if (margin != null) {
            if (margin.attributeValue("left") != null) {
                left = Integer.parseInt(margin.attributeValue("left"));
            }
            if (margin.attributeValue("right") != null) {
                right = Integer.parseInt(margin.attributeValue("right"));
            }
            if (margin.attributeValue("top") != null) {
                top = Integer.parseInt(margin.attributeValue("top"));
            }
            if (margin.attributeValue("bottom") != null) {
                bottom = Integer.parseInt(margin.attributeValue("bottom"));
            }
        }
    ...
    private void processSectionAttribute(Element sectPr)
    {
        ...
        if (pgSz != null)
        {
            ...
            Log.e("DOCX reader", "width = " + Integer.parseInt(pgSz.attributeValue("w")));
            Log.e("DOCX reader", "height = " + Integer.parseInt(pgSz.attributeValue("h")));
        }
        else {
            AttrManage.instance().setPageWidth(attr,
                    816);
