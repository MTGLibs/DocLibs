 ...
 * <p>
 */
public class ASheet extends Sheet implements com.wxiwei.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.wxiwei.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.wxiwei.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.wxiwei.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.wxiwei.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.wxiwei.office.ss.model.sheetProperty.ColumnInfo(
