...
public class LayoutKit
{
    ...
    public void layoutAllPage(PageRoot root, float zoom)
    {
        ...
        int dx = WPViewConstant.PAGE_SPACE_WIDTH;
        ...
        {
            dx += (int)(visibleWidth / zoom - width - WPViewConstant.PAGE_SPACE_WIDTH * 2) / 2;
        }
        while (pv != null)
        {
        ...
        Log.d("TAG", "layoutAllPage: "+dy+" "+zoom);
        root.setSize(width + WPViewConstant.PAGE_SPACE_WIDTH * 2, dy);
        ((Word)root.getContainer()).setSize(width + WPViewConstant.PAGE_SPACE_WIDTH * 2, dy);
    }
