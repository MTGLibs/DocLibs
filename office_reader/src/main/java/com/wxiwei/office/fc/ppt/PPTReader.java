...
public class PPTReader extends AbstractReader {
     ...
     * @param path
     */
    public PPTReader(IControl control, String filePath, Uri uri) {
        this(control, filePath, false, uri);
    }

    /**
     * @param path
     */
    public PPTReader(IControl control, String filePath, boolean isGetThumbnail, Uri uri) {
    ...
    public Object getModel() throws Exception {
        ...
        poiSlideShow = new SlideShow(new HSLFSlideShow(control, filePath, uri), isGetThumbnail);
    ...
    private com.wxiwei.office.common.borders.Line getShapeLine(SimpleShape shape) {
        return getShapeLine(shape, false);
    }

    private com.wxiwei.office.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine) {
        com.wxiwei.office.common.borders.Line line = null;
        if (shape != null && shape.hasLine()) {
            ...
            com.wxiwei.office.java.awt.Color color = ((SimpleShape) shape).getLineColor();

            if (color != null) {
                line = new com.wxiwei.office.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill) {
        ...
        if (fill != null) {
            ...
            if (type == BackgroundAndFill.FILL_BACKGROUND) {
                ...
                com.wxiwei.office.java.awt.Color fillColor = fill.getForegroundColor();
                com.wxiwei.office.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes) {
        if (notes != null) {
            ...
            for (Shape shape : notes.getShapes()) {
                ...
                if (shape instanceof com.wxiwei.office.fc.hslf.model.AutoShape  // 文本框
                        || shape instanceof com.wxiwei.office.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
                || shape instanceof com.wxiwei.office.fc.hslf.model.Freeform
                || shape instanceof com.wxiwei.office.fc.hslf.model.AutoShape
                || shape instanceof com.wxiwei.office.fc.hslf.model.TextBox
                || shape instanceof com.wxiwei.office.fc.hslf.model.Picture) {
            if (shape instanceof Line) {
                if (line != null) {
            ...
            } else if (shape instanceof com.wxiwei.office.fc.hslf.model.Freeform) {
                if (fill != null || line != null) {
                    ...
                    if (startArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = ((com.wxiwei.office.fc.hslf.model.Freeform) shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = ((com.wxiwei.office.fc.hslf.model.Freeform) shape).getEndArrowPathAndTail(rect);
                        if (arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null) {
                    ...
                    Path[] paths = ((com.wxiwei.office.fc.hslf.model.Freeform) shape).getFreeformPath(rect,
            ...
            } else if (shape instanceof com.wxiwei.office.fc.hslf.model.AutoShape
                    || shape instanceof com.wxiwei.office.fc.hslf.model.TextBox) {
                // autoShape
            ...
            // 图片
            else if (shape instanceof com.wxiwei.office.fc.hslf.model.Picture) {
                com.wxiwei.office.fc.hslf.model.Picture poiPic = (com.wxiwei.office.fc.hslf.model.Picture) shape;
        ...
        } else if (shape instanceof com.wxiwei.office.fc.hslf.model.Table) {
            com.wxiwei.office.fc.hslf.model.Table poiTable = (com.wxiwei.office.fc.hslf.model.Table) shape;
            if (poiTable != null) {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.wxiwei.office.fc.hslf.model.Table poiTable, GroupShape parent, int slideType) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                ...
                com.wxiwei.office.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null) {
        ...
        for (Line line : borders) {
            com.wxiwei.office.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null) {
    ...
    private int getBorderColor(Line line) {
        if (line != null) {
            com.wxiwei.office.java.awt.Color color = line.getLineColor();
            if (color != null) {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID) {
        ...
        if (text != null && text.trim().length() > 0) {
            ...
            int len = text.length();
            com.wxiwei.office.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.wxiwei.office.fc.hslf.record.TextHeaderAtom.TITLE_TYPE) {
                for (int i = 0; i < len; i++) {
                    if (abortReader) {
                        break;
                    }
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.wxiwei.office.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID) {
        ...
        com.wxiwei.office.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null) {
...
//      }
    ...
    public boolean searchContent(File file, String key) throws Exception {
        SlideShow slideShow = new SlideShow(new HSLFSlideShow(control, filePath, uri));
     ...
     *
     */
    private int converterColor(com.wxiwei.office.java.awt.Color color) {
//        if(color.getAlpha() == 0)
//        {
