...
public final class EventConstant
{
    ...
    public static final int APP_ZOOM_MAX_ID = APP_INIT_CALLOUTVIEW_ID + 1; // 0x20000005

    public static final int APP_ZOOM_DOWN_ID = APP_ZOOM_MAX_ID + 1;

    public static final int APP_ZOOM_UP_ID = APP_ZOOM_DOWN_ID + 1;

    public static final int APP_SCROLL_PERCENT_Y = APP_ZOOM_UP_ID + 1;
